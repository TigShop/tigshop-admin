<template>
    <div class="header-title-warp">
        <div class="breadcrumb">
            <ul>
                <li>
                    <a href="#"><span class="breadcrumb-span">首页</span></a
                    ><span class="breadcrumb-separator">/</span>
                </li>
                <li v-if="routerMatched[1]">
                    <span class="breadcrumb-span">{{ routerMatched[1].meta.title }}</span
                    ><span class="breadcrumb-separator">/</span>
                </li>
                <li v-if="routerMatched[2]">
                    <span class="breadcrumb-span">{{ routerMatched[2].meta.title }}</span>
                </li>
            </ul>
        </div>
