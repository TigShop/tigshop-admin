        ...
        <div class="main-panel">
            <ul>
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.product_view ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.product_view_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.product_view_growth_rate.toString() !== '--' &&
                                Number(filterState?.sales_data?.product_view_growth_rate) > 0
                            "
                ...
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.product_visitor ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.product_visitor_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.product_visitor_growth_rate.toString() !== '--' &&
                                Number(filterState?.sales_data?.product_visitor_growth_rate) > 0
                            "
                            class="admin-iconfont red f12 up"
                            >&#xe61a;</i
                        >
                ...
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.order_num ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.order_num_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.order_num_growth_rate.toString() !== '--' && Number(filterState?.sales_data?.order_num_growth_rate) > 0
                            "
                            class="admin-iconfont red f12 up"
                            >&#xe61a;</i
                        >
                ...
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.payment_amount ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.payment_amount_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.payment_amount_growth_rate.toString() !== '--' &&
                                Number(filterState?.sales_data?.payment_amount_growth_rate) > 0
                            "
                            class="admin-iconfont red f12 up"
                            >&#xe61a;</i
                        >
                ...
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.refund_amount ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.refund_amount_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.refund_amount_growth_rate.toString() !== '--' &&
                                Number(filterState?.sales_data?.refund_amount_growth_rate) > 0
                            "
                            class="admin-iconfont red f12 up"
                            >&#xe61a;</i
                        >
                ...
                <li class="main-panel-item">
                    ...
                    <div class="main-panel-item-value">{{ filterState?.sales_data?.refund_quantity ?? 0 }}</div>
                    <div class="main-panel-item-increase">
                        环比：
                        <span>{{ filterState?.sales_data?.refund_quantity_growth_rate }} %</span>
                        <i
                            v-if="
                                filterState?.sales_data?.refund_quantity_growth_rate.toString() !== '--' &&
                                Number(filterState?.sales_data?.refund_quantity_growth_rate) > 0
                            "
                            class="admin-iconfont red f12 up"
                            >&#xe61a;</i
                        >
...
const getData = async () => {
    try {
        ...
        if (result.errcode === 0) {
            ...
            const { horizontal_axis, longitudinal_axis_payment_amount, longitudinal_axis_product_view, longitudinal_axis_refund_amount } =
                result.sales_statistics_data;
            SalesDetailOptions.value.xAxis.data = horizontal_axis;
            SalesDetailOptions.value.series[0].data = longitudinal_axis_payment_amount;
            SalesDetailOptions.value.series[1].data = longitudinal_axis_refund_amount;
            SalesDetailRefChart?.setOption(SalesDetailOptions.value);
            NumberProductViewsOptions.value.xAxis.data = horizontal_axis;
            NumberProductViewsOptions.value.series[0].data = longitudinal_axis_product_view;
            NumberProductViewsChart?.setOption(NumberProductViewsOptions.value);
        }
    } catch (error: any) {
