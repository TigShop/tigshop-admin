    ...
    <div class="container">
        <div class="content_wrapper">
            <el-tabs v-model="activeKey" class="lyecs-tabs" tab-position="top" @tab-change="onTabChange">
                <el-tab-pane :name="-1" label="全部店铺"></el-tab-pane>
                <el-tab-pane :name="1" label="自营店铺"></el-tab-pane>
                <el-tab-pane :name="0" label="入驻店铺"></el-tab-pane>
            </el-tabs>
                ...
                <div class="lyecs-table-list-warp">
                        ...
                        <el-form :model="filterParams">
                            <div class="list-table-tool-row">
                                <div class="list-table-tool-col">
                                    <el-space>
                                        <el-input v-model="filterParams.keyword" name="keyword" placeholder="输入店铺/会员名称">
                                            <template #append>
                                ...
                                <div class="simple-form-warp">
                                    <!-- <div class="simple-form-field">
                                        <div class="form-group">
                                            <label class="control-label"><span>店铺等级：</span></label>
                                            <div class="control-container">
                                                <SelectArticleCategory v-model="filterParams.store_rank_id"></SelectArticleCategory>
                                            </div>
                                        </div>
                                    </div> -->
                                    <div class="simple-form-field">
                                        <div class="form-group">
                                            ...
                                            <div class="control-container">
                                                <el-select v-model="filterParams.store_status" clearable>
                                                    <!-- <el-option :value="0" label="请选择..."/> -->
                                                    <el-option :value="1" label="运营中" />
                                                    <el-option :value="2" label="盘点中" />
                                                    <el-option :value="3" label="强制关闭" />
                                                </el-select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="table-container">
                        <a-spin :spinning="loading">
                            <el-table :data="filterState" :loading="loading" :total="total" row-key="store_id" @selection-change="onSelectChange" @sort-change="onSortChange">
                                <el-table-column type="selection" width="32" />
                                <el-table-column :width="160" label="店铺名称" prop="store_title" sortable="custom"></el-table-column>
                                <el-table-column label="店铺LOGO">
                                    <template #default="{ row }">
                                        <Image :src="row.store_logo" fit="contain" style="height: 25px; width: 60px" />
                                    </template>
                                </el-table-column>
                                <el-table-column label="所属会员" prop="user_name"></el-table-column>
                                <el-table-column label="店铺类型">
                                    <template #default="{ row }">
                                        {{ row.is_self === 1 ? "自营" : "入驻" }}
                                    </template>
                                </el-table-column>
                                <el-table-column label="店铺等级" prop="store_rank_name"></el-table-column>
                                <el-table-column label="店铺状态">
                                    <template #default="{ row }">
                                        <span v-if="row.store_status === 0">待处理</span>
                                        <span v-else-if="row.store_status === 1" style="color: green">运营中</span>
                                        <span v-else-if="row.store_status === 2" style="color: blue">盘点中</span>
                                        <span v-else-if="row.store_status === 3" style="color: blue">强制关闭</span>
                                    </template>
                                </el-table-column>
                                <el-table-column :width="220" fixed="right" label="操作">
                                    <template #default="{ row }">
                                        ...
                                        <el-divider direction="vertical" />
                                        <DeleteRecord :params="{ id: row.store_id }" :requestApi="delStore" @afterDelete="loadFilter">删除</DeleteRecord>
                                    </template>
                                </el-table-column>
                                <template #empty>
...
import { batchSubmit, getStoreList, delStore } from "@/api/store/store";
