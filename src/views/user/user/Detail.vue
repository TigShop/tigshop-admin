                ...
                <div v-if="!loading">
                    <div class="container-card">
                        ...
                        <div class="info-card">
                            ...
                            <div class="card-info">
                                <div class="name">{{ formState.username }}</div>
                                <div class="gr">
                                    等级：<span class="rank">{{ formState.rank_name }}</span>
                                </div>
                                <el-row>
                                    <el-col :span="8">
                                        <PopForm
                                            v-model:org-value="formState.nickname"
                                            :max="10"
                                    ...
                                    <el-col :span="8"> 手机号：{{ formState.mobile }} </el-col>
                    ...
                    <div class="container-card">
                        ...
                        <div class="info-card">
                            <el-row style="width: 100%">
                                ...
                                <el-col :span="8"> 注册时间：{{ formState.reg_time }} </el-col>
                            </el-row>
                        </div>
                    </div>
                    <div class="container-card">
                        ...
                        <div class="info-card">
                            <el-row style="width: 100%; line-height: 30px">
                                ...
                                <el-col :span="8"> 所在地区：-- </el-col>
                                <el-col :span="16"> 详细地址：-- </el-col>
                            </el-row>
                        </div>
                    </div>
                    <div class="container-card">
