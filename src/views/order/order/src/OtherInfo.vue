    ...
    <div class="content_wrapper">
      <div class="lyecs-form-table">
        <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
          <el-form-item label="发票类型" prop="brand_name">
            <el-input v-model="formState.brand_name"/>
          </el-form-item>
          <el-form-item label="发票抬头" prop="brand_name">
            <el-input v-model="formState.brand_name"/>
          </el-form-item>
          <el-form-item label="发票内容" prop="brand_name">
            <el-input v-model="formState.brand_name"/>
          </el-form-item>
          <el-form-item label="客户给商家的留言" prop="brand_name">
            <el-input v-model="formState.brand_name" :autosize="{ minRows: 4, maxRows: 6}" type="textarea"/>
          </el-form-item>
          <el-form-item label="缺货处理" prop="brand_name">
            <el-input v-model="formState.brand_name"/>
          </el-form-item>
          <el-form-item v-show="!props.isDialog" :wrapper-col="{ offset: 4, span: 16 }">
            <el-button ref="submitBtn" class="form-submit-btn" type="primary" @click="onSubmit(formRef)">提交
            </el-button>
          </el-form-item>
        </el-form>
      </div>
