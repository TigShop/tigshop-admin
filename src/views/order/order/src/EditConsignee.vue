      ...
      <div class="lyecs-form-table">
        <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
          <el-form-item :rules="[{ required: true, message: '收货人不能为空!' }]" label="收货人" prop="consignee">
            <el-input v-model="formState.consignee" />
          </el-form-item>
          <el-form-item label="所在地区" prop="region_ids">
            <div style="width: 100%">
              <SelectRegion v-if="!loading" v-model="formState.region_ids"></SelectRegion>
            </div>
          </el-form-item>
          ...
          <el-form-item label="邮编" prop="postcode">
            <el-input v-model="formState.postcode" />
          </el-form-item>
          <el-form-item label="电子邮件" prop="email">
            <el-input v-model="formState.email" />
          </el-form-item>
          <el-form-item label="电话" prop="telephone">
            <el-input v-model="formState.telephone" />
          </el-form-item>
