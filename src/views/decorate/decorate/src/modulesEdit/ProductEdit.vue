<template>
    <perfect-scrollbar class="decorate-edit-con">
        ...
        <CommonTitleEdit v-model="module.title" type="product"></CommonTitleEdit>
    </perfect-scrollbar>
</template>
...
// import CommonProductEdit from "./src/CommonProductEdit.vue";
import CommonActivityFrameEdit from "./src/CommonActivityFrameEdit.vue";
