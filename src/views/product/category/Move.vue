<template>
    <div>
        <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
            ...
            <el-form-item>
                <div class="extra">什么是转移商品分类?
                    <br/>
                    如果需要对商品的分类进行变更,那么你可以通过此功能,正确管理你的商品分类。
                </div>
            </el-form-item>
            <el-form-item label="此分类" prop="id">
                <SelectCategory v-if="!loading" v-model:category_id="formState.id" :multiple="false"
                                style="width: 100%;"></SelectCategory>
            </el-form-item>
            <el-form-item>
                <div class="extra">转移至</div>
            </el-form-item>
            <el-form-item label="此分类" prop="target_cat_id">
                <SelectCategory v-if="!loading" v-model:category_id="formState.target_cat_id" :multiple="false"
                                style="width: 100%;"></SelectCategory>
            </el-form-item>
