<template>
    <el-select v-model="brand_id" :allowClear="true" :fieldNames="fieldNames" :filter-option="filterOption" clearable filterable placeholder="选择品牌" popper-class="brand-select"
        show-search @change="onChange" @visible-change="loadBrand">
        <template #default>
            <div class="option">
