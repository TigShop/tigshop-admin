    ...
    <div class="dec-picSelect-con">
        ...
        <div class="dec-pic-select">
            <div class="item-image">
                <div class="item-image-con" v-if="!photo.pic_thumb">
                    <DialogForm type="gallery" class="item-bg" @okCallback="onEdit" :params="{ isMultiple: false }" v-if="!photo.pic_thumb">
                        <div
                            class="flex"
                ...
                <div class="item-image-con" v-if="photo.pic_thumb">
                    <DialogForm type="gallery" class="" @okCallback="onEdit" :params="{ isMultiple: false }">
                        <img class="item-image-src" :src="imageFormat(photo.pic_thumb)" />
...
// 动态解析props
const photo = defineModel<any>("photo", { type: Object, default: { pic_url: "",pic_thumb: "" }});
