<template>
    <div >
        <draggable class="dec-goods-group-list" item-key="prodcut_id" :list="productList" ghost-class="ghost" chosen-class="chosenClass" animation="300" @start="" @end="">
                ...
                <div class="dec-goods-group-item dec-tip dec-goods-group-item-goods">
                    <div class="dec-goods-group-item-con">
                        <div class="item-goods-con">
                            <a href="" target="_blank"><img class="item-goods-img" :src="element.pic_thumb"></a>
                        </div>
            ...
            <template #footer>
                <DialogForm isDrawer @okCallback="onAdd" title="选择商品" width="600px" path="product/product/src/SelectProduct"
