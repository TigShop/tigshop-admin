...
export const getPcDecorateList = (params: object) => {
    return request<FilterResult>({
        url: "decorate/decorate/mobile_decorate/list",
        method: "get",
        params,
    });
};
...
export const batchSubmit = (type: string, data: object) => {
    return request({
        url: "decorate/decorate/mobile_decorate/batch?type=" + type,
        method: "post",
        data,
    });
};
...
export const delPcDecorate = (data: object) => {
    return request({
        url: "decorate/decorate/mobile_decorate/del",
        method: "post",
        data,
    });
};
...
export const updatePcDecorateFiled = (data: object) => {
    return request({
        url: "decorate/decorate/mobile_decorate/update_field",
        method: "post",
        data,
    });
};
...
export const getPcDecorate = (action: string, params: object) => {
    return request<FormResult>({
        url: "decorate/decorate/mobile_decorate/" + action,
        method: "get",
        params,
    });
};
...
export const updatePcDecorate = (operation: string, data: object) => {
    return request({
        url: "decorate/decorate/mobile_decorate/" + operation,
        method: "post",
        data,
    });
};
